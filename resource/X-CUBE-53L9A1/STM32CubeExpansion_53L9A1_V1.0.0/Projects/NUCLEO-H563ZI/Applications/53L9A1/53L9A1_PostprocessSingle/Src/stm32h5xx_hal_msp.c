...
/**
  ...
  * This function configures the hardware resources used for the STM32 -> XIAO
  * SPI bridge (hand-added, not CubeMX-regenerated - see MX_SPI4_Init() in
  * main.c, and stm32_utility/spi/spi.ino in the Arduino repo for the XIAO side).
...
/**
  ...
  * This function freezes the hardware resources used for the STM32 -> XIAO SPI
  * bridge (hand-added, not CubeMX-regenerated)
  * @param hspi: SPI handle pointer
  * @retval None
  */
